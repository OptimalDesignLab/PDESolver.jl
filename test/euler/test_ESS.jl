...
"""
  ...
  **Keywords**
   ...
   * isEC: if true, verify W^T R == 0, otherwise test that it is less than zero
"""
function runESTest_diagE(mesh, sbp, eqn, opts, flux_func::EulerEquationMod.FluxType; isEC=true)
