...
"""
function eqn_deepcopy(mesh::AbstractMesh{Tmsh}, sbp, eqn::SimpleODEData_{Tsol, Tres}, opts::Dict) where {Tmsh, Tsol, Tres}
  ...
  eqn_copy = SimpleODEData_{param_tuple...}(mesh, sbp, opts)
  copy!(eqn_copy, eqn)
