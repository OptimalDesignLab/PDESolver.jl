...
function call(obj::SRCx5plusy5, coords::AbstractVector, alpha_x, alpha_y, t)
  # u = calc_x5plusy5(coords, alpha_x, alpha_y, t)
  x = coords[1]
  y = coords[2]
...
function call(obj::SRCxplusy, coords::AbstractVector, alpha_x, alpha_y, t)
